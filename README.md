...
### 1. IoT 设备接入与实时监控
- 基于 **EMQX MQTT Broker** 接入温湿度、烟雾、红外计数、继电器控制等设备
- 设备数据实时采集、解析、入库，支持心跳检测与离线告警
- 摄像头视频流接入与智能分析
...
**作者**：何清彦  
**技术栈关键词**：Vue3 · TypeScript · Express · Prisma · MQTT · Socket.IO · Docker · 物联网 · 风险预警 · RBAC
